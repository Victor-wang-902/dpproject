...
class HungarianMatcher(nn.Module):
    ...
    def forward(self, outputs, targets):
        ...
        #print("out_prob_classes", out_prob.shape)
        print("out_prob", torch.argmax(out_prob,dim=1))
        ...
        out = box_cxcywh_to_xyxy(out_bbox)
        tgt = box_cxcywh_to_xyxy(tgt_bbox)
        #print("out", out)
        #print("tgt", tgt)
        ...
        #print("sizes", sizes)
        #print([c[i] for i, c in enumerate(C.split(sizes, -1))])
